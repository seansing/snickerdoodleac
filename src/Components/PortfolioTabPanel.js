...
function PortfolioTabPanel() {
  ...
  const NFTList = [
    ...
    {
      image:
        "https://lh3.googleusercontent.com/SERgQLZ2-nmMmtnneska-HZCgBVOoe8t7qZF6gUQRn3xiO5pjJLy5lJnGzQdJepS0Hnbz6H4sb2vIYkFXfufbC8EdtDrGiUedMgs=w1400-k",
  ...
  const statsList = {
    totalGasSpent: "$54",
    totalFundsSent: "1,684",
    totalFundsReceived: "1,723",
  };
